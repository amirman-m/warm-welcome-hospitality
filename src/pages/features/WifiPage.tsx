  ...
  return (
    <DynamicBackground>
      ...
      >
        ...
        {/* Header */}
        <div className="relative z-10 flex flex-col items-center mt-24 mb-8 animate-fade-in">
        ...
        {showDetails && (
          <div className={cn(
            "relative z-10 flex-1 flex flex-col items-center justify-center max-w-lg mx-auto w-full px-6",
